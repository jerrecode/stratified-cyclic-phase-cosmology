...
marginalized posterior contours from the official released DESI MCMC chains: BAO-only in the
$(\Omega_m,h\,r_d)$ plane and BBN-calibrated BAO in $(\Omega_m,H_0)$. The lower-left panel is a
model-implied posterior-predictive expansion history over the DESI BAO redshift lever arm; it is
not a continuous measurement of $H(z)$. The lower-right panel is a CAMB background calculation
showing $\Omega_{cb}$, $\Omega_\gamma$, total $\Omega_\nu$, and $\Omega_\Lambda$, so the massive
neutrino is not forced to scale as nonrelativistic matter at early times. The analysis uses the
pinned Results I/II likelihood; the later 2026 Lyman-$\alpha$ AP+BAO update is not combined without
a release-native joint product.}
